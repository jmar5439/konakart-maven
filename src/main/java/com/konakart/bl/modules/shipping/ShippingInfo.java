...
public class ShippingInfo
{
    ...
    public String toString()
    {
        ...
        str.append("originCountry = ").append(getOriginCountry()).append("\n");
        str.append("deliveryCountry = ").append(getDeliveryCountry()).append("\n");
        str.append("deliveryZone = ").append(getDeliveryZone()).append("\n");
