...
public class CustomerRegistrationSubmitAction extends BaseAction
{
    ...
    public String execute()
    {
        ...
        try
        {
            ...
            boolean allowNoRegister = (allowNoRegisterStr == null || !allowNoRegisterStr
            ...
            cr.setCity(getCity());
            cr.setCompany(getCompany());
            cr.setCountryId(getCountryId());
            cr.setEmailAddr(getEmailAddr());
            cr.setFaxNumber(getFaxNumber());
            cr.setFirstName(getFirstName());
            cr.setGender(getGender());
            cr.setLastName(getLastName());
            cr.setNewsletter(getNewsletter());
            cr.setPassword(getPassword());
            cr.setPostcode(getPostcode());
            cr.setProductNotifications(getProductNotifications());
            cr.setState(getState());
            cr.setStreetAddress(getStreetAddress());
            cr.setStreetAddress1(getStreetAddress1());
            cr.setSuburb(getSuburb());
            cr.setTelephoneNumber(getTelephoneNumber());
            cr.setTelephoneNumber1(getTelephoneNumber1());
            cr.setAddressCustom1(getAddressCustom1());
            cr.setAddressCustom2(getAddressCustom2());
            cr.setAddressCustom3(getAddressCustom3());
            cr.setAddressCustom4(getAddressCustom4());
            cr.setAddressCustom5(getAddressCustom5());
            cr.setCustomerCustom1(getCustomerCustom1());
            cr.setCustomerCustom2(getCustomerCustom2());
            cr.setCustomerCustom3(getCustomerCustom3());
            cr.setCustomerCustom4(getCustomerCustom4());
            cr.setCustomerCustom5(getCustomerCustom5());
            ...
            if (allowNoRegister)
            {
                ...
                kkAppEng.getCustomerMgr().login(cr.getEmailAddr(), randomPassword);
                return "Checkout";
            }
            ...
            kkAppEng.getCustomerMgr().login(getEmailAddr(), getPassword());
