 ...
 */
public class EditGiftRegistrySubmitAction extends BaseAction
{
    ...
    public String execute()
    {
        ...
        try
        {
            ...
            // If it is a temporary customer, then he needs to register to edit a gift registry
            ...
            WishListIf wl = kkAppEng.getWishListMgr().getCurrentWishList();
            if (wl == null)
            {
            ...
            /*
             * Edit the current wish list
             */
            wl.setCustom1(getCustom1());
            wl.setCustom2(getCustom2());
            wl.setCustom3(getCustom3());
            wl.setCustom4(getCustom4());
            wl.setCustom5(getCustom5());
            wl.setCustomer1FirstName(getFirstName1());
            wl.setCustomer1LastName(getLastName1());
            wl.setCustomerFirstName(getFirstName());
            wl.setCustomerLastName(getLastName());
            wl.setLinkUrl(getLinkURL());
            wl.setName(getRegistryName());
            ...
            // Edit the wish list
            kkAppEng.getWishListMgr().editWishList(wl);
