...
public class EditAddrSubmitAction extends BaseAction
{
    ...
    public String execute()
    {
        ...
        try
        {
            ...
            addr.setFirstName(getFirstName());
            addr.setGender(getGender());
            addr.setLastName(getLastName());
            ...
            addr.setTelephoneNumber(getTelephoneNumber());
            addr.setTelephoneNumber1(getTelephoneNumber1());
            addr.setEmailAddr(getEmailAddrOptional());
