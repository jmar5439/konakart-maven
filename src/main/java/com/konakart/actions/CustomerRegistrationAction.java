...
public class CustomerRegistrationAction extends BaseAction
{
    ...
    private String allowNoRegisterStr;
    ...
    /**
     * @return the allowNoRegisterStr
     */
    public String getAllowNoRegisterStr()
    {
        return allowNoRegisterStr;
    }

    /**
     * @param allowNoRegisterStr
     *            the allowNoRegisterStr to set
     */
    public void setAllowNoRegisterStr(String allowNoRegisterStr)
    {
        this.allowNoRegisterStr = allowNoRegisterStr;
    }
